...
export default function Footer(props: any) {
    return (
        <footer className="bg-white flex flex-col gap-3 items-center justify-center font-Josefin h-28 border-t-2 py-5 px-10 tracking-wider w-screen z-50 mt-auto mb-0">
